...
class TestGroupPage(TestBase):
    ...
    def test_group_location(self):
        """При входе как админ по умолчанию попадаем в окно с локацией
        'Dnipro' это и проверяем, протестировано"""
        groups_page = LogInPage(self.driver) \
            .user_name("hello") \
            .user_password('1234') \
            .submit_log_in()
        expected_result = 'Dnipro'
        group_location = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.group_location())
    ...
    def test_is_enabled_button_search(self):
        ...
        groups_page = LogInPage(self.driver) \
            ...
            .user_password('1234') \
            .submit_log_in()
        button_search = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_search())
    ...
    def test_is_enable_button_my_groups(self):
        ...
        groups_page = LogInPage(self.driver) \
            ...
            .user_password('1234') \
            .submit_log_in()
        button_my_groups = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_my_groups())
        assert button_my_groups.is_enabled()

    def test_is_enable_button_all_groups(self):
        """Доступна ли кнопка allGroups, но она есть и невидима,
        и странно чт тест проходт!"""
        groups_page = LogInPage(self.driver) \
            .user_name("hello") \
            .user_password('1234') \
            .submit_log_in()
        button_all_groups = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_all_groups())
    ...
    def test_is_enable_button_ended_groups(self):
        ...
        groups_page = LogInPage(self.driver) \
            ...
            .user_password('1234') \
            .submit_log_in()
        button_ended_groups = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_ended_groups())
    ...
    def test_is_enable_button_current_groups(self):
        ...
        groups_page = LogInPage(self.driver) \
            ...
            .user_password('1234') \
            .submit_log_in()
        button_current_groups = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_current_groups())
    ...
    def test_is_enable_button_future_groups(self):
        ...
        groups_page = LogInPage(self.driver) \
            ...
            .user_password('1234') \
            .submit_log_in()
        button_future_groups = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.button_future_groups())
    ...
    def test_groups_list(self):
        ...
        actual_list_group = WebDriverWait(self.driver, 10).\
            until(lambda driver: groups_page.groups_list())
