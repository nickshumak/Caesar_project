...
# fields for student
    ...
    PRE_INTERMEDIATE_LOW = (By.XPATH, './/*[@id = "modal-window"]/div/section/section/div[4]/div[1]/select/option[2]')
    ...
    BUTTON_ADDING_CV = (By.XPATH, './/*[@id="modal-window"]/div/section/section/div[5]/div[1]/button')
    INPUT_ADDING_CV = (By.XPATH, './/*[@id="modal-window"]/div/section/section/div[5]/div[1]/input')
    FILE_NAME_CV = (By.CLASS_NAME, 'list-item')
    BUTTON_ADDING_PHOTO = (By.XPATH, './/*[@id="modal-window"]/div/section/section/div[5]/div[2]/button')
    INPUT_ADDING_PHOTO = (By.XPATH, './/*[@id="modal-window"]/div/section/section/div[5]/div[2]/input')
    FILE_NAME_PHOTO = (By.XPATH, './/*[@id="modal-window"]/div/section/section/div[5]/div[2]/ul/li/span[1]')
