...
class StudentsPage(BasePage):
    ...
    def select_group_students(self):
        groups_list = \
            WebDriverWait(self.driver, 40).until(
                lambda driver: self.driver.find_elements(*GroupPageLocators.GROUPS))
    ...
    def students_table(self):
        students_data = []
        list_rows = \
            self.driver.find_elements(*StudentsListLocators.STUDENTS_LISTS_ROWS)
        for column in list_rows:
            students_data.append(column.text)
        return students_data

    def click_button_edit_students_list(self):
        self.driver.find_element(*StudentsListLocators.BUTTON_EDIT_STUDENTS_LIST).click()
        return self

    def click_button_delete_first_student(self):
        self.driver.find_element(*EditStudentsListLocators.BUTTON_DELETE_STUDENT).click()
        WebDriverWait(self.driver, 20). \
            until(lambda driver: self.driver.find_element(*EditStudentsListLocators.
                                                          BUTTON_CONFIRM_DELETING)).click()
        return self

    def click_button_add_new_student(self):
        self.driver.find_element(*EditStudentsListLocators.BUTTON_ADD_NEW_STUDENT).click()
        return self

    def click_button_edit_student(self):
        self.driver.find_element(*EditStudentsListLocators.BUTTON_EDIT_STUDENT).click()
        return self
    ...
    def input_data_new_student(self, student):
        ...
        self.driver.find_element(*EditStudentsListLocators.
                                 STUDENT_ENTRY_SCORE).send_keys(student.entry_mark)
        # select_who_approved
    ...
    def input_data_for_edit_student(self, student):
        ...
        self.driver.find_element(*EditStudentsListLocators.
                                 TEXT_FIELD_FIRST_NAME).send_keys(student.first_name)
        self.driver.find_element(*EditStudentsListLocators.TEXT_FIELD_LAST_NAME).clear()
        self.driver.find_element(*EditStudentsListLocators.
                                 TEXT_FIELD_LAST_NAME).send_keys(student.last_name)
        # select_english_level
        self.driver.find_element(*EditStudentsListLocators.LIST_ENGLISH_LEVEL).click()
        ...
        self.driver.find_element(*EditStudentsListLocators.
                                 STUDENT_MARK_INCOMING_TEST).send_keys(student.incoming_mark)
        self.driver.find_element(*EditStudentsListLocators.STUDENT_ENTRY_SCORE).clear()
        self.driver.find_element(*EditStudentsListLocators.
                                 STUDENT_ENTRY_SCORE).send_keys(student.entry_mark)
        # select_who_approved
        self.driver.find_element(*EditStudentsListLocators.STUDENT_APPROVED_BY).click()
...
def data_student_for_check(student):
    data_student = [student.last_name, student.first_name, 'Pre-intermediate low',
                    student.incoming_mark, student.entry_mark, 'N. Varenko']
