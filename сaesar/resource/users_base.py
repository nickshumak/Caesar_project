...
second_admin = User("Petr", "Kucher", "Administrator", "Dnipro", "hello", "1234")
third_admin = User("Andriy", "Pereymybida", "Administrator", "Lviv", "admin", "1234")
fourth_admin = User("Artur", "Koval", "Administrator", "Dnipro", "artur", "1234")
