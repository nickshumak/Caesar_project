...
data = {'url_for_test_start': 'http://localhost:3000/Students/Dnipro/'
                              'DP-093-JS/list',
        # expected variables
        'expected_url_group_info':
            'http://localhost:3000/Groups/Dnipro/DP-093-JS/info',
